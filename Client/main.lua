...
RegisterNetEvent('gh-AngryAi:client:spawn')
AddEventHandler('gh-AngryAi:client:spawn', function(model, duration)
...
RegisterNetEvent('gh-AngryAi:client:Start')
AddEventHandler('gh-AngryAi:client:Start', function()
    START = true
